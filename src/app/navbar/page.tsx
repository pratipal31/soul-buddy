...
import { HomeIcon, UserCircleIcon, ChatBubbleLeftRightIcon, SunIcon } from "@heroicons/react/24/outline";
  ...
  return (
    <header className="bg-gradient-to-r from-red-900 to-red-600 shadow-lg">
      <nav className="container mx-auto flex items-center justify-between px-6 py-4">
        {/* Logo */}
        <Link href="/" className="text-2xl font-extrabold text-white flex items-center space-x-2">
...
const NavLink: React.FC<{ href: string; text: string; Icon: React.FC<any>; closeMenu?: () => void }> = ({
  href,
  text,
  Icon,
  closeMenu,
